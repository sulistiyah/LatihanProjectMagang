...
class CameraConnectionFragment (
    ...
    private fun showToast(text: String) {
        ...
        if (activity != null) {
            activity.runOnUiThread(
                Runnable { Toast.makeText(activity, text, Toast.LENGTH_SHORT).show() })
        }
    }
    ...
    private fun setUpCameraOutputs() {
        ...
        try {
            val characteristics: CameraCharacteristics = manager.getCameraCharacteristics(cameraId.toString())
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        try {
            ...
            manager.openCamera(cameraId.toString(), stateCallback, backgroundHandler)
        } catch (e: CameraAccessException) {
            LOGGER.e(e, "Exception!")
    ...
    private fun createCameraPreviewSession() {
        try {
            ...
            cameraDevice?.createCaptureSession(
                listOf<Surface>(surface, previewReader!!.surface),
